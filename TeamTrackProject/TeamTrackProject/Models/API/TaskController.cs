...
{/// <summary>
 ...
 /// </summary>
    ...
    public class TaskProgettoController : ControllerBase
    {
        ...
        [HttpPost("{progettoId}/{userId}")]
        public ActionResult<TaskProgetto> CreaTask(int progettoId, int userId, [FromForm] string nome, [FromForm] string descrizione, [FromForm] Priorità prioritàTask, [FromForm] DateTime dataInizioTask, [FromForm] DateTime dataFineTask, [FromForm] Stato statoTask)
        {
            try
            {
        ...
        /// </summary>
        /// <param name="id">ID dell'utente che sta richiedendo le task.</param>
