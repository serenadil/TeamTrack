...
namespace TeamTrackProject.Models.Infrastrutture
{
    ...
    public class TeamTrackDbContext : DbContext
    {
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            ...
            {
                optionsBuilder.UseSqlServer("Server=localhost;Database=TeamTrackDB;Trusted_Connection=True;TrustServerCertificate=True;");
            }
        }
